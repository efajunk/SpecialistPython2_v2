...
class TestAccountTask2(unittest.TestCase):
    def setUp(self):  # special method which runs before each next methods
    ...
    def test_deposit(self):  # test_ is important key to launch tests
        self.accounts[0].deposit(500)
        self.assertEqual(self.accounts[0].balance, 800)  # assert method runs test. compare the value in
    ...
    def test_full_info(self):
        ...
        self.assertIn("300", self.accounts[0].full_info())  # assertIn check if the method contains the value.
